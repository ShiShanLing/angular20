# iOS 技术学习路线（`ios.job.cursor.md`）

> 与 `ios.learning.cursor.md` **互补**：那条偏「体系与深度」，本条偏 **常问什么、你要能讲什么、写什么 demo 能撑住简历**。
>
...
| `ios.job.cursor.md` | **排课优先级、话术与自检**，复习前滚动复习 |

可按目标日期设日历提醒：**T-14 过完 P0，T-7 过完 P1 + 简历故事，T-2 只听自己的录音复述**。
